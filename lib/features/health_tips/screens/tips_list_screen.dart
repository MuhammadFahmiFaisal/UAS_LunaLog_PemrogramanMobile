...
class TipsListScreen extends StatelessWidget {
  ...
  Widget _buildCategoryCardLarge({
    required IconData icon,
    required Color iconBg,
    required Color iconColor,
    required String title,
  ...
  Widget _buildReadingListSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _buildReadingItem(
          context: context,
          title: '5 Makanan Pereda Nyeri',
          subtitle: 'Nutrisi yang tepat dapat membantu menyeimbangkan hormon secara alami...',
        ),
      ],
    );
  }
        ...
        children: [
          Container(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(8),
              child: Image.network(
                'https://lh3.googleusercontent.com/aida-public/AB6AXuBvKgVvkjxS5Tt6skkNVsq516VfsE1WFKem05ZdbghyuhlJduZpnOzKSUIQSj-r9iZ1GE0abYIg2_qHdhhhybFsaevKIhHJOG6DENn9dsL1wMMR9mR9yLW7NhsZpkkPx5UtiIkWGFSrEnE_5YTlqwcsCsJnxtEMKGGbS8ckSADP29Qcoqm7yX7TsrZG_sKc_D3zlP9ADWkiNgoS06Ft3-JLtfxraZdPqQ1_WpXJvmxvt4RI3GFOeifSXRbh9ceO_lZJt2_qN_l8RQ',
                fit: BoxFit.cover,
                errorBuilder: (context, error, stackTrace) {
                  return Container(
                    decoration: const BoxDecoration(
